...
export default function FlowRibbons(props: Record<string, unknown>) {
  return <__OriginkitBase_FlowRibbons {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
